...
python train_latent_prior.py \
  --encoder vits --img-size 518 --epochs 3 --bs 2 --seed "${SEED}" \
  ...
  --wat3r-hole-weight 0.02 --wat3r-hole-grad-weight 0.25 \
  --wat3r-mv-weight 0.05 --wat3r-confidence-quantile 0.60 \
